...
const { unwrapMEK, wrapMEK, wrapMEKWithRecoveryKey, generateRecoveryKey, generateVerifier } = require('../lib/crypto');
...
async function changePasswordCommand() {
  ...
  console.log('✓ Master password changed. All parked projects are still accessible.');
}
